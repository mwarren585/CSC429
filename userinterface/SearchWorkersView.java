...
public class SearchWorkersView extends View{
    // GUI components
    ...
    private VBox createFormContent()
    {
        ...
        Text prompt = new Text("WORKER SEARCH INFORMATION");
        prompt.setWrappingWidth(400);
        prompt.setTextAlignment(TextAlignment.CENTER);
        prompt.setFill(Color.BLACK);
        grid.add(prompt, 0, 0, 2, 1);

        Text accNumLabel = new Text(" Worker First Name: ");
        ...
        Text accNumLabe2 = new Text(" Worker Last Name: ");
    ...
    //---------------------------------------------------------
    public void processWorkerSearchData() {
        String first = firstName.getText();
        String last = lastName.getText();
        Properties p = new Properties();
        p.setProperty("firstName", first);
        p.setProperty("lastName", last);
        myModel.stateChangeRequest("FindWorkers", p);
    }
}
