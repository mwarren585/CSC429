...
public abstract class EntityBase extends Persistable
    ...
    protected Properties persistentState;    // the field names and values from the src.database
    private final String myTableName;                // the name of our src.database table
    ...
    protected EntityBase(String tablename) {
        ...
        // extract the schema from the src.database, calls methods in subclasses
        initializeSchema(myTableName);

        // create a place to hold our state from the src.database
        ...
        referenceCount = 0;
        // indicate the data in persistentState matches the src.database contents
        dirty = false;
    }
