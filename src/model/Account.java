...
public class    Account extends EntityBase implements IView {
    ...
    public Account(String accountNumber)
        ...
        // If no account found for this user name, throw an src.exception
        else {
    ...
    private void updateStateInDatabase() {
        try {
            if (persistentState.getProperty("AccountNumber") != null) {
                ...
                updateStatusMessage = "Account data for account number : " + persistentState.getProperty("AccountNumber") + " updated successfully in src.database!";
            } else {
            ...
            updateStatusMessage = "Error in installing account data in src.database!";
        }
