...
//     */
//    //----------------------------------------------------------
//    public TransferTransaction(AccountHoWlder cust)
//            throws Exception {
//        super(cust);
//    }
//
...
//            return myAccountIDs;
//        } else if (key.equals("SourceAccount") == true) {
//            return source;
//        } else if (key.equals("DestAccount") == true) {
//            return dest;
//        } else if (key.equals("TransferAmount") == true) {
...
//            doYourJob();
//        } else if (key.equals("DoTransfer") == true) {
