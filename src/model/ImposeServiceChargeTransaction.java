...
public class ImposeServiceChargeTransaction extends Transaction {
     ...
     */
    //----------------------------------------------------------
    public ImposeServiceChargeTransaction(Worker cust)
            throws Exception {
        super(cust);
    }
    ...
    public Object getState(String key) {
        ...
        } else if (key.equals("AccountList") == true) {
            return accounts;
        } else if (key.equals("SelectedAccount") == true) {
    ...
    public void stateChangeRequest(String key, Object value) {
        ...
        } else if (key.equals("AccountHolderIDEntered") == true) {
        ...
        } else if (key.equals("CancelAccountList") == true) {
            createAndShowAccountHolderIDEntryView();
        } else if (key.equals("AccountCancelled") == true) {
            createAndShowAccountListView();
        }
