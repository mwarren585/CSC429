...
public class BalanceInquiryTransactionView extends View {
    ...
    // constructor for this class -- takes a src.model object
    //----------------------------------------------------------
    ...
    private VBox createFormContent() {
        ...
        cancelButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                 ...
                 * It simply tells its src.model (controller) that the balance inquiry transaction was canceled, and leaves it
