...
//************************************************************
//
//	$Source: /cvsroot/ATM/implementation/src.event/Event.java,v $
//
...
public class Event {
    ...
    // String values corresponding to the various src.event levels
    ...
    /**
     * Name of the method in which the src.event occurred
     */
    String myMethod;

    /**
     * A description of the src.event
     */
    String myDescription;

    /**
     * A timestamp for the src.event
     */
    String myTime;

    /**
     * Tag used for internationalization of the src.event description
     */
    String myTag;
    ...
    /**
     * An ordinal severity level for this src.event
     */
    int mySeverity;
     ...
     *
     * @param    source    Name of class in which src.event occurred
     *
     * @param    name    Name of method in which src.event occurred
     *
     * @param    description    Plain English description of src.event details
     *
     * @param    severity    Ordinal severity level for src.event
     */
    //----------------------------------------------------------
     ...
     * @param    severity    Ordinal severity level for src.event
     *
     * @param    //sync    boolean indicating whether the src.event is synchronous or asynchronous
     *
     */
    //----------------------------------------------------------
     ...
     *
     * @return String value providing a displayable form of the src.event in a format
    ...
    /**
     * Returns the class from which this src.event was generated
     *
    ...
    /**
     * Returns the parameter list associated with this src.event
     *
    ...
    /**
     * Returns the internationalization tag associated with the src.event
     *
    ...
    /**
     * Returns the method name from which this src.event was generated
     *
    ...
    /**
     * Returns the plain English description of this src.event
     *
    ...
    /**
     * Returns a string containing the date and time of this src.event in US date format
     *
     * @return String object containing the date and time of this src.event in US date format
     */
    //----------------------------------------------------------
    ...
    /**
     * Returns a String description of the severity level of this src.event
     *
     * @return String object indicating the severity level of this src.event
     */
    //----------------------------------------------------------
    ...
    /**
     * Returns an ordinal value of the severity level of this src.event
     *
     * @return int value indicating the severity level of this src.event
     */
    //----------------------------------------------------------
