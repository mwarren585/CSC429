...
//************************************************************
//
//	$Source: /cvsroot/ATM/implementation/src.event/EventLog.java,v $
//
 ...
 * We first have the date and time of the src.event, followed by an indication of the class in which the Event was generated,
...
public class EventLog {
    ...
    /**
     * Set the messages bundle so we can translate the tags in the src.event
    ...
    /**
     * Actual method called to add an src.event to the log file
     *
    ...
    public void addEvent(Event event) {
        ...
        // decide if this src.event should be shown to the user
        if ((event.getSeverityDesc().equals("Warning") == true) ||
            ...
            if (allowPopupDisplay == true) {
                ...
                if (myMessages == null) {
                    ...
                    // if there are translations available, but this src.event doesn't support them, use raw text
     ...
     *
     * @param    source    The actual description of the src.event (with embedded parameter points) that
