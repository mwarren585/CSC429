...
//************************************************************
//
//	$Source: /cvsroot/ATM/implementation/src.exception/InvalidPrimaryKeyException.java,v $
//
//	Reason: This class indicates an src.exception that is thrown
//			if the primary key is not properly supplied to the 
//			data access src.model object as it seeks to retrieve
...
/**
 * This class indicates an src.exception that is thrown if the primary
 * key is not properly supplied to the data access src.model object as
 * it seeks to retrieve a record from the src.database
 *
 */
//--------------------------------------------------------------
public class InvalidPrimaryKeyException
     ...
     *
     * @param //mesg The message associated with the src.exception
     */
    //--------------------------------------------------------
